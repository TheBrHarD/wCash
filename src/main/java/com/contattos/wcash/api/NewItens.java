...
public class NewItens
{
    public static ItemStack add(Material m, String s, Enchantment digSpeed, int i, Enchantment durability, int i1, Enchantment lootBonusBlocks, int i2)
    {
    ...
    public static ItemStack add(Material m, String nome, int quantidade, int durabilidade, String[] lore){
        ItemStack item = new ItemStack(m, quantidade);
        item.setDurability((short)durabilidade);
        ItemMeta meta = item.getItemMeta();
